...
def get_senteces_containing_word(sentence_to_search, word1):
    ...
    # words_search = [word1.lower(), word2.lower()]
    # Convertint them to a dictiorairy
    word_sentence_dictionary = {word1:[]}
...
def read_file_from_excel(file):
    ...
    for i in range(0, len(excel_file)):
        ...
        """
        result.append((get_senteces_containing_word(str(excel_file.iloc[i]['Text']), 'shall')))
